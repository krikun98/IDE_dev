...
namespace JetBrains.ReSharper.Plugins.PascalDev
{
    ...
    public class PascalDevProjectFileLanguageService : ProjectFileLanguageService
    {
        public PascalDevProjectFileLanguageService(ProjectFileType projectFileType) : base(projectFileType)
        {
        }
        ...
        {
            return PascalDevLanguage.Instance;
        }

        public override ILexerFactory GetMixedLexerFactory(ISolution solution, IBuffer buffer,
            IPsiSourceFile sourceFile = null)
        {
            return new PascalDevLanguageService.PascalDevLexerFactory();
        }

        protected override PsiLanguageType PsiLanguageType => PascalDevLanguage.Instance;
