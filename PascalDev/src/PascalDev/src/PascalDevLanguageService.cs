...
namespace JetBrains.ReSharper.Plugins.PascalDev
{
  ...
  class PascalDevLanguageService : LanguageService
  {
    public PascalDevLanguageService([NotNull] PsiLanguageType psiLanguageType,
    ...
    {
      return new PascalDevLexerFactory();
    }
    ...
    {
      return new PascalDevParser(lexer);
    }
    ...
    internal class PascalDevLexerFactory : ILexerFactory
    {
      public ILexer CreateLexer(IBuffer buffer)
      {
        return new PascalDevLexer(buffer);
      }
    }
  }
}