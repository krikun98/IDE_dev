...
public partial class PascalParser : Parser {
	...
	public partial class CompoundStatementContext : ParserRuleContext {
		...
		public ITerminalNode[] SEMICOLON() { return GetTokens(PascalParser.SEMICOLON); }
	...
	public partial class BodyContext : ParserRuleContext {
		...
		public ITerminalNode SEMICOLON() { return GetToken(PascalParser.SEMICOLON, 0); }
	...
	public SimpleStatementContext simpleStatement() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 101; assigmnentStatement();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 102; procedureStatement();
				}
				break;
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 103; gotoStatement();
				}
				break;
			}
		}
	...
	public partial class AssigmnentStatementContext : ParserRuleContext {
		public ITerminalNode Identifier() { return GetToken(PascalParser.Identifier, 0); }
	...
	public partial class AssignmentContext : ParserRuleContext {
		...
		public ITerminalNode PLUSASSIGN() { return GetToken(PascalParser.PLUSASSIGN, 0); }
		public ITerminalNode MINUSASSIGN() { return GetToken(PascalParser.MINUSASSIGN, 0); }
		public ITerminalNode MULTASSIGN() { return GetToken(PascalParser.MULTASSIGN, 0); }
		public ITerminalNode DIVASSIGN() { return GetToken(PascalParser.DIVASSIGN, 0); }
	...
	public partial class LabelContext : ParserRuleContext {
		public ITerminalNode Number() { return GetToken(PascalParser.Number, 0); }
		public ITerminalNode Identifier() { return GetToken(PascalParser.Identifier, 0); }
	...
	public StructuredStatementContext structuredStatement() {
		...
		try {
			...
			case If:
				EnterOuterAlt(_localctx, 2);
				{
				State = 122; conditionalStatement();
				}
				break;
			case For:
			case Repeat:
			case While:
				EnterOuterAlt(_localctx, 3);
				{
				State = 123; repetitiveStatement();
				}
				break;
			case With:
				EnterOuterAlt(_localctx, 4);
				{
				State = 124; withStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public RepetitiveStatementContext repetitiveStatement() {
		...
		try {
			...
			case For:
				EnterOuterAlt(_localctx, 1);
				{
				State = 131; forStatement();
				}
				break;
			case Repeat:
				EnterOuterAlt(_localctx, 2);
				{
				State = 132; repeatStatement();
				}
				break;
			case While:
				EnterOuterAlt(_localctx, 3);
				{
				State = 133; whileStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public partial class CaseContext : ParserRuleContext {
		...
		public CaseRangeContext caseRange(int i) {
	...
	public partial class CaseRangeContext : ParserRuleContext {
		...
		public ITerminalNode DOTS() { return GetToken(PascalParser.DOTS, 0); }
	...
	public partial class ConstantContext : ParserRuleContext {
		public ITerminalNode Number() { return GetToken(PascalParser.Number, 0); }
		public ITerminalNode CharacterString() { return GetToken(PascalParser.CharacterString, 0); }
	...
	public partial class ElsePartContext : ParserRuleContext {
		...
		public ITerminalNode Otherwise() { return GetToken(PascalParser.Otherwise, 0); }
	...
	public partial class WithStatementContext : ParserRuleContext {
		...
		public ITerminalNode[] Identifier() { return GetTokens(PascalParser.Identifier); }
	...
	public partial class ExpressionContext : ParserRuleContext {
		...
		public ITerminalNode Comparison() { return GetToken(PascalParser.Comparison, 0); }
	...
	public partial class SimpleExpressionContext : ParserRuleContext {
		...
		public ITerminalNode[] Addition() { return GetTokens(PascalParser.Addition); }
		public ITerminalNode Addition(int i) {
	...
	public partial class TermContext : ParserRuleContext {
		...
		public ITerminalNode[] Multiplication() { return GetTokens(PascalParser.Multiplication); }
		public ITerminalNode Multiplication(int i) {
	...
	public TermContext term() {
		...
		try {
			...
			while (_la==Multiplication) {
				{
				{
				State = 245; Match(Multiplication);
				State = 246; factor();
				}
				}
				State = 251;
	...
	public partial class FactorContext : ParserRuleContext {
		public ITerminalNode LBRC() { return GetToken(PascalParser.LBRC, 0); }
		public ExpressionContext expression() {
			return GetRuleContext<ExpressionContext>(0);
		}
		public ITerminalNode RBRC() { return GetToken(PascalParser.RBRC, 0); }
		public ITerminalNode Identifier() { return GetToken(PascalParser.Identifier, 0); }
		...
		public ITerminalNode Signum() { return GetToken(PascalParser.Signum, 0); }
	...
	public FactorContext factor() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 252; Match(LBRC);
				State = 253; expression();
				State = 254; Match(RBRC);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
			...
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 257; functionCall();
				}
				break;
			case 4:
				EnterOuterAlt(_localctx, 4);
				{
				State = 258; unsignedConstant();
				}
				break;
			case 5:
			...
			case 7:
				...
				{
				State = 263; setConstructor();
				}
				break;
			case 8:
				EnterOuterAlt(_localctx, 8);
				{
				State = 264; valueTypecast();
				}
				break;
			case 9:
				EnterOuterAlt(_localctx, 9);
				{
				State = 265; addressFactor();
				}
				break;
			}
		}
	...
	public partial class SetConstructorContext : ParserRuleContext {
		public ITerminalNode[] RBKT() { return GetTokens(PascalParser.RBKT); }
		public ITerminalNode RBKT(int i) {
			return GetToken(PascalParser.RBKT, i);
		}
		public SetGroupContext[] setGroup() {
			return GetRuleContexts<SetGroupContext>();
		}
		public SetGroupContext setGroup(int i) {
	...
	public ValueTypecastContext valueTypecast() {
		...
		try {
			...
			State = 304; Match(LBRC);
			State = 305; expression();
			State = 306; Match(RBRC);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
