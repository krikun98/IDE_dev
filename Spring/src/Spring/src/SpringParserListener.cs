...
{
    public class SpringParserListener : PascalParserBaseListener
    {
        private readonly PsiBuilder _builder;
        private readonly Stack<int> _marks = new Stack<int>();

        public SpringParserListener(PsiBuilder builder)
        {
            _builder = builder;
        }
        ...
        {
            _builder.Done(_marks.Pop(), SpringCompositeNodeType.BLOCK, null);
        }
    }
}